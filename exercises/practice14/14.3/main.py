# 3) Prenez la liste des dictionnaires que nous avons créés à partir de l’ensemble de données sur les fleurs d’Iris (dataset iris) et écrivez-la dans un nouveau fichier au format CSV.


# Dictionnaire à convertir en csv
irises = [
